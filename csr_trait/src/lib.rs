...
pub trait CSR: Sized {
    ...
    fn read_write(&mut self, val: u32) -> usize {
        util::read_write_reg(self, val)
    }

    fn set(&mut self, val: u32) {
        util::set_reg(self, val);
    }
    fn read_set(&mut self, val: u32) -> usize {
        util::read_set_reg(self, val)
    }

    fn clear(&mut self, val: u32) {
        util::clear_reg(self, val);
    }
    fn read_clear(&mut self, val: u32) -> usize {
        util::read_clear_reg(self, val)
    }
...
mod util {
    ...
    #[inline(always)]
    pub fn read_write_reg(reg: &mut impl CSR, val: u32) -> usize {
        if is_val_statically_known(val) {
            unsafe {
                match val {
    ...
    #[inline(always)]
    pub fn set_reg(reg: &mut impl CSR, val: u32) {
        if is_val_statically_known(val) {
            unsafe {
                match val {
                    0 => reg.set_const::<0>(),
    ...
    #[inline(always)]
    pub fn read_set_reg(reg: &mut impl CSR, val: u32) -> usize {
        if is_val_statically_known(val) {
            unsafe {
                match val {
    ...
    #[inline(always)]
    pub fn clear_reg(reg: &mut impl CSR, val: u32) {
        if is_val_statically_known(val) {
            unsafe {
                match val {
                    0 => reg.clear_const::<0>(),
    ...
    #[inline(always)]
    pub fn read_clear_reg(reg: &mut impl CSR, val: u32) -> usize {
        if is_val_statically_known(val) {
            unsafe {
                match val {
